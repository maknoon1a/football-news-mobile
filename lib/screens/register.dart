                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        if (context.mounted) {
                          // Ubah pengecekan status - bisa true (boolean) atau 'success' (string)
                          if (response['status'] == true || response['status'] == 'success') {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Failed to register! ${response['message'] ?? 'Unknown error'}'),
                                backgroundColor: Colors.red,
                              ),
                            );
                          }
                        ...
                        // Tangkap error dari network atau parsing
                        print('Error: $e');
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
